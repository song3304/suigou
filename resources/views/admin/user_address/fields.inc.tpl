<div class="form-group">
	...
	<div class="col-md-9">
		<select name="uid" class="select-model form-control" data-model="admin/member" data-text="{{username}}" data-term="{{username}}" data-placeholder="请输入用户名" value="<{$_data.uid}>"></select>
	</div>
</div>
<div class="form-group">
	<label class="col-md-3 control-label" for="account_num">收货人</label>
	<div class="col-md-9">
		<input type="text" id="receiver" name="receiver" class="form-control" placeholder="请输入收货人" value="<{$_data.receiver}>">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="col-md-3 control-label" for="postal_code">邮编</label>
	<div class="col-md-9">
		<input type="text" id="postal_code" name="postal_code" class="form-control" placeholder="请输入邮编..." value="<{$_data.postal_code}>">
	</div>
</div>
